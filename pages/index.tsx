...
const Home: NextPage = () => {
  const [bgHeight, setHeight] = React.useState("0");
  React.useEffect(() => {
    if (bgHeight === "0" && typeof window !== "undefined" && typeof document !== "undefined") {
      window.addEventListener("load", () => {
        setHeight(document.body.getBoundingClientRect().height + "px");
      });
    }
  }, [bgHeight]);
  return (
